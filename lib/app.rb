...
def connect_N
  ...
  #Selectionne 5 journalistes au hasard
  
tweet_journalistes = 5.times.map {
  journalistes[rand(0...journalistes.length)]
}.uniq

  # Envoies un tweet aux 5 journalistes choisi précédement.
  
tweet_journalistes.each {
    |x| connect_N.update("Hello, your last article was cool #{x} ! #Hello_world @the_hacking_pro")
}


  # Follow et like les tweets contenant #Hello world.
